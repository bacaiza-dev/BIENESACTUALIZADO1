          ...
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <input v-model="form.clase_de_bien" list="clasesBienOptions" type="text" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <VueMultiselect v-model="selectedUbicacion" :options="ubicaciones" :searchable="true"
                  :close-on-select="true" :show-labels="false" placeholder="Buscar ubicación..." label="nombre"
                  track-by="id" />
              ...
              <div>
                ...
                <VueMultiselect v-model="selectedResponsable" :options="usuarios" :searchable="true"
                  :close-on-select="true" :show-labels="false" placeholder="Buscar responsable..." label="nombre"
                  track-by="id" :custom-label="({ nombre, apellido }) => `${nombre} ${apellido}`" />
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input v-model="form.marca" type="text" placeholder="Ej: HP, Dell, Samsung"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <input v-model="form.modelo" type="text" placeholder="Ej: ProBook 450 G8"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <input v-model="form.serie" type="text" placeholder="Ej: 5CD1234567"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <input v-model="form.anioFabricacion" type="number" min="1900" :max="new Date().getFullYear()"
                  placeholder="Ej: 2021"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              </div>
            </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input v-model="form.codigo_senescyt" type="text" placeholder="Código SENESCYT del bien"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              ...
              <div>
                ...
                <input v-model="form.proveedor" type="text" placeholder="Ej: Tecnología Avanzada S.A."
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 gap-4">
              <div>
                ...
                <textarea v-model="form.descripcion" rows="3" placeholder="Descripción detallada del bien..."
              ...
              <div>
                ...
                <textarea v-model="form.observaciones" rows="2" placeholder="Observaciones adicionales..."
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"></textarea>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input v-model="form.nro_acta_entrega_recepcion" type="text"
              ...
              <div>
                ...
                <input v-model="form.nro_acta_constatacion_fisica" type="text"
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input v-model="form.color" type="text" placeholder="Color del bien"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <input v-model="form.material" type="text" placeholder="Material de construcción"
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white" />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
