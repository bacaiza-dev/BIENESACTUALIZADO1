<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <!-- Main Content Area - Scrolls naturally with page -->
    ...
    <!-- Loading Overlay -->
    <div v-if="uiStore.loading" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
