  ...
  <header class="sticky top-0 z-40 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center justify-between h-16 px-4 lg:px-6">
      <div class="flex items-center space-x-2">
        ...
        <button @click="uiStore.toggleSidebarCollapsed"
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="hidden md:block">
          <div class="relative">
            <input v-model="searchQuery" type="text" placeholder="Buscar... (Ctrl+K)"
        ...
        <button v-if="shouldShowQRScanner" @click="$router.push('/qr-scanner')"
        ...
        <div class="relative">
          <button @click="toggleNotifications"
            ...
            <span v-if="uiStore.unreadCount > 0"
          ...
          <div v-if="showNotifications"
            ...
            <div class="max-h-96 overflow-y-auto">
              <div v-if="uiStore.notifications.length === 0" class="p-4 text-center text-gray-500 dark:text-gray-400">
            ...
            <div v-if="uiStore.notifications.length > 0" class="p-3 border-t border-gray-200 dark:border-gray-700">
              <button @click="uiStore.markAllAsRead"
